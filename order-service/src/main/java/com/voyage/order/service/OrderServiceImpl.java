...
import com.voyage.order.dto.*;
import com.voyage.order.dto.kafka.OrderEvent;
import com.voyage.order.dto.kafka.PaymentEvent;
import com.voyage.order.dto.orderResponse.OrderResponse;
import com.voyage.order.dto.product.Product;
import com.voyage.order.entity.*;
import com.voyage.order.feign.AuthService;
import com.voyage.order.feign.CartService;
import com.voyage.order.feign.ProductService;
import com.voyage.order.repository.OrderRepository;
import com.voyage.order.repository.PaymentStatusRepository;
import com.voyage.order.repository.ProductCountRepository;
import com.voyage.order.repository.ShippingDetailsRepository;
...
public class OrderServiceImpl implements OrderService, OnMessageReceived {
    ...
    public ResponseEntity<?> createOrder(HttpServletRequest request, ShippingDetailsRequest shippingDetailsRequest) {
        ...
        List<com.voyage.order.entity.Product> productCountList = new ArrayList<>();
        ...
        for (Product product : productList) {
            productCountList.add(
                    com.voyage.order.entity.Product.builder()
    ...
    private OrderResponse mapToOrderResponse(Order order) {
        ...
        for (com.voyage.order.entity.Product product : order.getProducts()) {
